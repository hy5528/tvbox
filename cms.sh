...
sudo docker run -d --name=cms --restart=unless-stopped -v /opt/mysql:/var/lib/mysql -e MYSQL_ROOT_PASSWORD:123456 -e MYSQL_USER:admin -e MYSQL_PASSWORD:123456 --network=1panel-network --ip=172.18.0.3 yobasystems/alpine-mariadb:latest
